...
tetes peuvent etre specialisees, redondantes, distribuées ou difficiles a interpreter.
...
| softmax = classification | softmax transforme genericquement des scores en poids normalises |
